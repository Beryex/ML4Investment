...
def sample_training_data(X_train: pd.DataFrame, 
    ...
    target_sample_number = settings.TARGET_TRAINING_SAMPLE_NUMBER
    logger.info(f"Target total training sample number: {target_sample_number}")
    ...
    for month, proportion in sampling_proportion.items():
        ...
        cur_month_sample_number = round(target_sample_number * proportion)
