...
class Settings:
    ...
    STOCK_SECTOR_ID_MAP_PTH: str = "data/stock_sector_id_mapping.json"
    ...
    N_SPLIT: int = 5
    NUM_ROUNDS: int = 1000
    DATA_SAMPLING_PROPORTION_SEARCH_LIMIT: int = 1
    HYPERPARAMETER_SEARCH_LIMIT: int = 1
    FEATURE_SEARCH_LIMIT: int = 1
