...
class Settings:
    ...
    # Model Training
    TRAINING_DATA_START_DATE: str = '2020-01-01'
    TRAINING_DATA_END_DATE: str = '2024-12-31'
    VALIDATION_DATA_START_DATE: str = '2025-01-01'
