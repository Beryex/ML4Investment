...
# Model Training
TRAINING_DATA_START_DATE = '2020-01-01'
TRAINING_DATA_END_DATE = '2024-12-31'
VALIDATION_DATA_START_DATE = '2025-01-01'
VALIDATION_DATA_END_DATE = '2025-05-31'
TARGET_TRAINING_SAMPLE_SIZE = 64000
N_SPLIT = 5
NUM_ROUNDS = 1000
DATA_SAMPLING_PROPORTION_SEARCH_LIMIT = 100
HYPERPARAMETER_SEARCH_LIMIT = 100
FEATURE_SEARCH_LIMIT = 100
PREDICT_STOCK_SEARCH_LIMIT = 100
...
# Evaluation
TESTING_DATA_START_DATE = '2025-06-01'
TESTING_DATA_END_DATE = None
